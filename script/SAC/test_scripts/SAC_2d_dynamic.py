...
config.environment = deep_mobile_printing_2d1r(data_path="../../../Env/2D/data_2d_dynamic_"+PLAN_NAME+"_envplan_500_test.pkl", random_choose_paln=True)
...
if __name__ == "__main__":
    ...
    dictPath = '../train_scripts/SAC/2D/dynamic/SAC_2d_'+PLAN_NAME+'_seed_'+str(args.seed)+'/Actor_net_episode_'+str(args.model)+'.pth'
    AGENTS = [SAC_Discrete]
