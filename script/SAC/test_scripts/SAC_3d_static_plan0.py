...
config.environment = deep_mobile_printing_3d1r(plan_choose=0)
...
config.hyperparameters = {
    ...
    "Actor_Critic_Agents":  {
        ...
        "learning_rate": 0.001,
        "linear_hidden_units": [64, 128, 256, 128, 64],
...
if __name__ == "__main__":
    ...
    test = True
    dictPath = 'results/data_and_graphs/Actor_net_episode_381.pth'
    AGENTS = [SAC_Discrete]
