...
from DMP_simulator_3d_dynamic_triangle_MCTS import deep_mobile_printing_3d1r
...
def main(cfg):
    ...
    OUT_FILE_NAME="DQN_MCTS_3ddynamic_"+PLAN_NAME+"_lr"+str(Lr)+"_rollouts"+str(ROLLOUT)+"_ucb_constant"+str(UCB_CONSTANT)+"_seed_"+str(seeds)
    print(OUT_FILE_NAME)
    model_dir=args.model_dir+"/"+OUT_FILE_NAME+"/"
    env = deep_mobile_printing_3d1r(data_path="../../../Env/3D/data_3d_dynamic_"+PLAN_NAME+"_envplan_500_train.pkl")
