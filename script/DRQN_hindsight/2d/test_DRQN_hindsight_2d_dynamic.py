...
def main(args):
    ...
    PLAN_CHOICE=args.plan_choose  # 0 dense, 1 sparse
    PLAN_NAME=PLAN_LIST[PLAN_CHOICE]
    save_path = "./DRQN_Hindsight/2D/plot_" + PLAN_NAME + "/"
    load_path = "./log/dynamic/DRQN_hindsight_2d_"
    ...
    log_path = load_path + PLAN_NAME + "_lr"+str(Lr)+"_seed_"+str(seeds)+"/Eval_net_episode_"
    ...
    save_file = save_path +"Lr" + str(Lr) + "_Plan" + str(PLAN_CHOICE) +'_seed'+str(seeds)
