...
from DMP_Env_2D_dynamic_hindsight_replay import deep_mobile_printing_2d1r_hindsight
def set_seed(seeds):
...
print(OUT_FILE_NAME)
log_path="/mnt/NAS/home/WenyuHan/SNAC/DRQN_Hindsight/2D/log/dynamic/"+OUT_FILE_NAME+"/"
env = deep_mobile_printing_2d1r(plan_choose=PALN_CHOICE)
env_hindsight = deep_mobile_printing_2d1r_hindsight(plan_choose=PALN_CHOICE)
...
best_reward = -500
total_steps = 0
writer = SummaryWriter('/mnt/NAS/home/WenyuHan/SNAC/DRQN_Hindsight/2D/DRQN_hindsight_2d_dynamic')
