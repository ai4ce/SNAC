...
from DMP_simulator_3d_static_circle_hindsight_replay import deep_mobile_printing_3d1r_hindsight
def set_seed(seeds):
...
print(OUT_FILE_NAME)
log_path="/mnt/NAS/home/WenyuHan/SNAC/DRQN_Hindsight/3D/log/static/"+OUT_FILE_NAME+"/"
...
best_reward=-500
total_steps = 0
writer = SummaryWriter('/mnt/NAS/home/WenyuHan/SNAC/DRQN_Hindsight/3D/DRQN_hindsight_3d_static')
