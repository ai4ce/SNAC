...
save_path = "./log/DRQN_hindsight/plot/3D/Dynamic/"
load_path = "./log/DRQN_hindsight/3D/Dynamic/plan_"
...
for plan_choose in range(2):
    ...
    PLAN_CHOICE=plan_choose  # 0 dense, 1 sparse
    PLAN_NAME=PLAN_LIST[PLAN_CHOICE]
    env = deep_mobile_printing_3d1r(data_path="../../../Env/3D/data_3d_dynamic_"+PLAN_NAME+"_envplan_500_test.pkl", random_choose_paln=False)
    ######################
    # hyper parameter
    minibatch_size = 64
    Lr = 0.0001
