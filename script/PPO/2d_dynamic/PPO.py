...
import time
import DMP_Env_2D_dynamic_test
import DMP_Env_2D_dynamic 
...
def main_exp(arg):
    env = DMP_Env_2D_dynamic.deep_mobile_printing_2d1r(plan_choose=arg["plan_choose"])
...
log_path="/mnt/NAS/home/WenyuHan/SNAC/PPO/2D/log/dynamic/"
...
"learning_rate":0.00025, "vf_coef":0.5, "cliprange":0.1, "nminibatches":100,\
 ...
 "tensorboard_log": "/mnt/NAS/home/WenyuHan/SNAC/PPO/2D/dynamic/",\
 "seed":seeds,\
...
#     env = DMP_Env_2D_dynamic_test.deep_mobile_printing_2d1r(plan_choose=plan_choose, test_set=test_set)
