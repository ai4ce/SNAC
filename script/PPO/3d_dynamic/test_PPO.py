...
def main_exp(arg):
    ...
    env = deep_mobile_printing_3d1r(data_path=dir_path + "/data_3d_dynamic_"+arg["PLAN_NAME"]+"_envplan_500_test.pkl", random_choose_paln=False)
    ...
    env.render(ax1,ax2,iou_min=iou_min,iou_average=iou_test_total,iter_times=arg["N_iteration_test"],best_env=best_env,best_iou=best_iou,best_step=best_step,best_brick=best_brick,position_memo=best_posi,best_plan=best_plan)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--plan-choose', default=0, type=int, help='dynamic has: dense 0, sparse 1')
    ...
    "graph_save_path":log_path+"_ppt_plan_"+PLAN_NAME+"_lr" + str(args.lr) + "_seed"+str(seeds),\
    "tensorboard_log": "./PPO/3D/dynamic/",\
    "seed":seeds,\
