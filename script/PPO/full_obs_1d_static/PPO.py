...
import time
from DMP_Env_1D_static import MDP_deep_mobile_printing_1d1r
...
plan = 0
def main_exp(arg):
    env = MDP_deep_mobile_printing_1d1r(plan_choose=plan)
...
if __name__ == "__main__":
    arg = {"gamma":0.99, "n_steps":100000, "noptepochs":4, "ent_coef":0.01, "learning_rate":0.00025, "vf_coef":0.5, "cliprange":0.1, "nminibatches":100, "tb_log_name":"with_uncertainty"}
