...
OUT_FILE_NAME="DRQN_1d_"+"sin"+"_lr"+str(Lr)+"_seed_"+str(seeds)
print(OUT_FILE_NAME)
log_path="/mnt/NAS/home/WenyuHan/SNAC/DRQN/1D/log/dynamic/"+OUT_FILE_NAME+"/"
...
best_reward = -500
total_steps = 0
writer = SummaryWriter('/mnt/NAS/home/WenyuHan/SNAC/DRQN/1D/DRQN_1d_dynamic')
