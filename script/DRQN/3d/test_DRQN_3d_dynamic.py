...
save_path = "./log/DRQN/plot/3D/Dynamic/"
load_path = "./log/DRQN/3D/Dynamic/plan_"
test_set = ['../../../Env/3D/data_2d_dynamic_dense_envplan_500_test.pkl',
        '../../../Env/3D/data_2d_dynamic_sparse_envplan_500_test.pkl']
...
for plan_choose in range(2):
    env = deep_mobile_printing_3d1r(data_path=test_set[plan_choose], random_choose_paln=False)
    ######################
    # hyper parameter
    minibatch_size = 64
    Lr = 0.0001
