...
save_path = "/mnt/NAS/home/WenyuHan/SNAC/DRQN/2D/log/train_with_expertise/"
load_path ="/mnt/NAS/home/WenyuHan/SNAC/DRQN/2D/log/train_with_expertise/"+OUT_FILE_NAME+"/"
...
plt.savefig(save_path + "Plan" + str(PALN_CHOICE) + "_seed_"+str(seeds)+'.png')
