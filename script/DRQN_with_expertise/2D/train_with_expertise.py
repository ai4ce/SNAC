...
print(OUT_FILE_NAME)
log_path="/mnt/NAS/home/WenyuHan/SNAC/DRQN/2D/log/train_with_expertise/"+OUT_FILE_NAME+"/"
...
best_reward=-500
total_steps = 0
writer = SummaryWriter('/mnt/NAS/home/WenyuHan/SNAC/DRQN/2D/train_with_expertise')
