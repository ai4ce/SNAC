...
load_path = "./log/DQN_1d_sin_lr0.001_rollouts50_ucb_constant0.5/"
...
env = deep_mobile_printing_1d1r_MCTS_obs_test(plan_choose=0)
    ######################
    # hyper parameter
minibatch_size=2000
Lr=0.001
...
log_path = load_path + "Eval_net_episode_189"
...
plt.savefig(save_path+"Plan"+str(0)+'.png')
