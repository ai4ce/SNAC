...
from DMP_Env_1D_static_Lnet_test import deep_mobile_printing_1d1r
import model
import argparse
...
def main(args):
    ...
    seed = args.seed
    PALN_CHOICE = args.plan_choice
    PLAN_LIST = ["sin","gaussian","step"]
    PLAN_NAME = PLAN_LIST[PALN_CHOICE]
    save_path = "./log/plot/1D_static_DRQN_with_Lnet/"
    load_path = "./log/static_with_Lnet/DRQN_1d_Lnet_" + PLAN_NAME + "_lr" + str(lr) + "_seed_" + str(seed)
    ...
    model_checkpoint = torch.load("./1d/model_1D_explicit_" + PLAN_NAME + "_lstm/Lr_0.0001_batchsize_10/model_01000000.pth", map_location=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--plan-choice', default=1, type=int, help='sin: 0, gaussian: 1, step: 2')
